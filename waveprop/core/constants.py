...
This module contains the Constants object, which gets initialized for later use

Attributes
----------
constants: Constants
    constants-instance for later use
...
constants = Constants()  # create the constants-instance for later use
